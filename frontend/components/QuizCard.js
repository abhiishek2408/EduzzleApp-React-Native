...
export function QuizCardSection({ navigation, user, route }) {
    ...
    <View className="mb-6">
      ...
      <View className="flex-row justify-between items-center">
        <View className="flex-row items-center ml-4 gap-1">
          <Ionicons name="flame-outline" size={28} color="#a21caf" />
          <Text className="text-[18px] font-extrabold text-[#2d0c57]">
            Popular Challenges
          </Text>
        </View>
        ...
        <TouchableOpacity
          ...
          className="mr-4 py-1.5 px-3 rounded-2xl border border-[#e9d5ff] bg-[#faf5ff]"
        >
          <Text className="text-xs font-bold text-[#a21caf]">View All</Text>
        </TouchableOpacity>
      </View>
